...
const requests = {
  requestPopular: `https://api.themoviedb.org/3/movie/popular?api_key=&language=en-US&page1`,
  requestTopRated: `https://api.themoviedb.org/3/movie/top_rated?api_key=${Key}&language=en-US&page1`,
  requestTrending: `https://api.themoviedb.org/3/movie/top_rated?api_key=${Key}&language=en-US&page2`,
